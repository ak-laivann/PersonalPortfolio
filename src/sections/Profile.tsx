...
export const Profile = () => {
  return (
    <div className="profile-container">
      ...
      <div className="texts-alone">
        <div className="animatethisfont">
          Hi, I am Anantha Krishnan G! &nbsp;
        </div>
        <br />
        <Typography.Paragraph className="paragraphStyle">
          ...
          to engineering sciences. A passionate engineer with a unique blend of
        ...
        <Typography.Paragraph className="paragraphStyle">
          ...
          spans working with technologies like ReactJS, NodeJS, MongoDB, AWS,
          GCP, Azure as well as mechanical concepts like lean engineering,
          hydraulics and pneumatics, industrial safety, etc.
        </Typography.Paragraph>
        <Typography.Paragraph className="paragraphStyle">
